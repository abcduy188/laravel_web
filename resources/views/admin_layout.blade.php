    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Bug Shop</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{URL::to  ('/admin/all-category-product') }}"><b>Liệt kê danh mục
                            sản phẩm</b> </a>
                        <a class="collapse-item" href="{{URL::to  ('/admin/add-category-product') }}">Thêm danh mục sản
                            phẩm</a>
                        <a class="collapse-item" href="{{URL::to  ('/admin/deleted-category-product') }}">Danh mục đã xóa</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseProduct"
                    ...
                    <i class="fas fa-light fa-laptop"></i>
                    <span>Sản phẩm</span>
                </a>
                <div id="collapseProduct" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{URL::to  ('/admin/all-product') }}"> <b>Liệt kê sản phẩm</b></a>

                        <a class="collapse-item" href="{{URL::to  ('/admin/add-product') }}">Thêm sản phẩm</a>
                        <a class="collapse-item" href="{{URL::to  ('/admin/deleted-product') }}">Sản phẩm đã xóa</a>
                    </div>
                </div>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle"
                                            src="{{ asset('public/backend/img/undraw_profile_1.svg') }}" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle"
                                            src="{{ asset('public/backend/img/undraw_profile_2.svg') }}" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle"
                                            src="{{ asset('public/backend/img/undraw_profile_3.svg') }}" alt="...">
