                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{URL::to ('sendcode') }}" method="POST">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="Email" aria-describedby="emailHelp"
                                                placeholder="Nhập code" name="code" required>
                                        </div>
                                        @endif
                                        <input type="submit" class="btn btn-primary btn-user btn-block" value="Send code"/>
                                       
                                    </form>
                                    <hr>
    
                                    <div class="text-center">
                                        <a class="small" href="{{ url('/register') }}">Create an Account Auth</a>
                                    </div>
                                </div>
                            </div>
                        </div>
